...
// 评分评语（按分数区间）
// 满分机制：1本命(+4) + 9精通(×3) = 31分
const COMMENTS = [
  { min: 0,  max: 5,  text: '看来你还只是个路人……要不要试一局？' },
  { min: 6,  max: 12, text: '新手上路，握紧扳机！' },
  { min: 13, max: 18, text: '已经摸到命运的边缘了~' },
  { min: 19, max: 24, text: '老练的 Awakener，战场上见过你！' },
  { min: 25, max: 29, text: '你对这片战场了如指掌，厉害！' },
  { min: 30, max: 30, text: '你就是命运吧唧高手！' },
